...
import { Scroll, Wrench, Users, Shield, Zap, Globe, LucideCakeSlice } from "lucide-react";
...
export default function SMPInfoSite() {
  const mods = [
    ...
    },
    {
      ...
      category: "Gameplay",
      type: "Server-side",
      description: "Removes the obnoxious block delay of the shield, so it works the moment you press Right-Click. No more delay and confusion"
    },
    {
    ...
    },
    {
      ...
      category: "Cosmetic",
      type: "Server-Side",
      description: "Make banners wearable in the helmet slot, just like for pillagers"
    },
    {
      name: "LuckPerms",
      category: "Admin",
    ...
    },
    {
      ...
      category: "Admin",
      type: "Server-side",
      description: "A hard-to-break, grief-resistant solution for preventing players from entering The End."
    },
    {
    ...
    },
    {
      ...
      category: "Utility",
      type: "Server-side",
      description: "Harvest full trees and huge mushrooms instantly with an axe. Shift+right-click the base block of a tree to fell the entire tree at once."
    },
    {
      name: "Fsit",
      category: "Social",
    ...
    },
    {
      ...
      category: "Cosmetic",
      type: "Server-side",
      description: "Turn images into maps! Visit the modpage to see usage instructions."
    },
    {
      name: "Krypton",
      category: "Performance",
    ...
    },
    {
      ...
      category: "Social",
      type: "Server-side",
      description: "Easy to configure welcome messages for server players logging in with URL support."
    },
    {
      name: "Ledger",
      category: "Admin",
  ...
  const datapacks = [
    ...
    },
    {
      ...
      category: "Cosmetic",
      type: "Function",
      description: "Adds a unique book that allows you to alter the properties of armor stands in survival. Simply sign the book and quill title to 'Statues' and use it on an armor stand to toggle its properties."
    },
    {
      name: "Mini blocks",
      category: "Cosmetic",
      type: "Building",
      description: "Use a stonecutter to craft certain blocks into mini blocks (heads textured like blocks)."
    },
    {
      name: "Blasting Plus",
      category: "Quality of Life",
      type: "Crafting",
      description: "Makes various items and blocks smeltable in the Blast Furnace for faster smelting."
    },
    {
      name: "More effective tools",
      category: "Quality of Life",
      type: "Gameplay",
      description: "Sets an effective tool for blocks that annoyingly don't have one (e.g. pickaxe for glass, axe for cactus). This excludes blocks specifically intended to have no effective tool (e.g. powder snow, reinforced deepslate, vault)."
    },
    {
      name: "Decorative Player Heads",
      category: "Cosmetic",
      type: "Building",
      description: "Craft decorative player heads using common material, and rename it to a player's username to apply their skin texture."
    },
    {
      name: "Builder's Wand",
      category: "Quality of Life",
      type: "Building",
      description: "Craft Builder's Wand heads using diamonds, amethysts, and a brush. With a block on your offhand and wand in main hand, right-click to place multiples of that blocks at once."
    },
    {
    ...
    },
    {
      ...
      category: "Cosmetic",
      type: "Function",
      description: "Enter '/trigger color' to list the colors in chat and select your desired username color."
    },
    {
      name: "Ender Chest Always Drops",
      category: "Quality of Life",
      type: "Gameplay",
      description: "Ender Chests always drop when broken, even without silk touch."
    },
    {
      name: "Silence Mobs",
      category: "Cosmetic",
      type: "Function",
      description: "Adds the ability to lock a mob's age using a name tag. 'Silence me'; 'silence me'; 'silence_me' are all acceptable names."
    },
    {
      name: "fast leaf decay",
      category: "Quality of Life",
      type: "Gameplay",
      description: "Leaves decay much faster when trees are mined in survival mode."
    },
    {
      name: "Silk Touch budding amethyst",
      category: "Quality of Life",
      type: "Building",
      description: "Lets you collect budding amethyst using a silk touch pickaxe."
    },
    {
    ...
    },
    {
      ...
      category: "Quality of Life",
      type: "Crafting",
      description: "Makes various items and blocks smeltable in the Smoker for faster smelting."
    },
    {
      name: "Blossoming Pots",
      category: "Cosmetic",
      type: "Building",
      description: "Greatly expands the selection of potable plants. Allows the use of Decorated Pots as abnormally large Flower Pots."
    },
    {
    ...
    },
    {
      ...
      category: "Quality of Life",
      type: "Crafting",
      description: "Slabs/Stairs back to blocks, Powder to glass, Blackstone as cobblestone, More shapeless recipes, Universal dyeing, Sandstone dyeing, Coal/charcoal to black dye, Copper powered rails, Cook flesh to leather, Dropper to dispenser, Block to 2 slabs, Craftablility (notch apples, gravel, blackstone), Unpackable blocks"
    },
    {
      name: "Kill Empty Boats",
      category: "Management",
      type: "Utility",
      description: "Adds a function for admins to kill all boats without passengers."
    }
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-2 lg:px-4 pb-20">
          <Tabs defaultValue="about" className="w-full">
            <TabsList className="mb-5 bg-neutral-800/80 backdrop-blur-md border border-neutral-700 p-1.5 rounded-xl shadow-lg">
              <TabsTrigger value="about" className="rounded-lg px-6 py-1 text-sm font-medium transition-all data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-500/20 data-[state=active]:to-blue-600/20 data-[state=active]:text-blue-300 data-[state=active]:shadow-lg data-[state=active]:border data-[state=active]:border-blue-500/30 data-[state=inactive]:text-neutral-400 data-[state=inactive]:hover:text-neutral-200 data-[state=inactive]:hover:bg-neutral-700/50">
                Getting Started
              </TabsTrigger>
              <TabsTrigger value="mods" className="rounded-lg px-6 py-1 text-sm font-medium transition-all data-[state=active]:bg-gradient-to-br data-[state=active]:from-emerald-500/20 data-[state=active]:to-emerald-600/20 data-[state=active]:text-emerald-300 data-[state=active]:shadow-lg data-[state=active]:border data-[state=active]:border-emerald-500/30 data-[state=inactive]:text-neutral-400 data-[state=inactive]:hover:text-neutral-200 data-[state=inactive]:hover:bg-neutral-700/50">
                Server Mods ({mods.length})
              </TabsTrigger>
              <TabsTrigger value="datapacks" className="rounded-lg px-6 py-1 text-sm font-medium transition-all data-[state=active]:bg-gradient-to-br data-[state=active]:from-cyan-500/20 data-[state=active]:to-cyan-600/20 data-[state=active]:text-cyan-300 data-[state=active]:shadow-lg data-[state=active]:border data-[state=active]:border-cyan-500/30 data-[state=inactive]:text-neutral-400 data-[state=inactive]:hover:text-neutral-200 data-[state=inactive]:hover:bg-neutral-700/50">
            ...
            <TabsContent value="mods" className="space-y-">
              <div className="bg-neutral-800/50 backdrop-blur-sm border border-neutral-700 rounded-lg p-3 mb-8">
                ...
                <p className="text-neutral-300">
                  These mods run on the server and enhance performance, gameplay, and functionality. They're server-side only and don't require client installation.
                </p>
              </div>
                ...
                <CardContent className="p-5 space-y-2">
                  <div>
                    ...
                    <p className="text-neutral-400 leading-relaxed">
                      This server runs on Fabric with a mix of performance mods and vanilla-plus datapacks to enhance the survival experience without straying too far from vanilla.
                    </p>
                  </div>
                  ...
                  <div className="border-t border-neutral-700 pt-2">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 text-sm">
                      ...
                      <div className="bg-neutral-900/50 rounded-lg p-4">
                        ...
                        <p className="text-neutral-100 font-semibold">207.148.69.38:25565</p>
                      </div>
                      <div className="bg-neutral-900/50 rounded-lg p-4">
                  ...
                  <div className="border-t border-neutral-700 pt-3">
                    ...
                    <div className="bg-neutral-900/50 rounded-lg p-4 space-y-2 font-mono text-sm">
                      <div className="flex gap-3">
                        ...
                        <span className="text-neutral-400">Change your username color</span>
                      </div>
                      <div className="flex gap-3">
                        <span className="text-emerald-400">/sit</span>
                        <span className="text-neutral-400">Sit anywhere on command</span>
                      </div>
                      <div className="flex gap-3">
                        <span className="text-emerald-400">/crawl</span>
                        <span className="text-neutral-400">Crawl anywhere on command</span>
                      </div>
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="text-neutral-400 text-sm leading-snug">
                            Creates map of specified size (in pixels, single map is 128x128) More info here: https://modrinth.com/mod/image2map
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 backdrop-blur-sm border-indigo-500/30">
                <CardContent className="p-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-1 text-neutral-100">Voice Chat Enabled</h3>
                      <p className="text-neutral-300 text-sm leading-relaxed">
                        We support and recommend <span className="font-semibold text-indigo-300"><a href="https://modrinth.com/plugin/simple-voice-chat">Simple Voice Chat</a></span> Fabric mod for proximity-based voice communication. 
                        Talk to nearby players naturally with 3D positional audio. The mod is optional to enhance the multiplayer experience significantly.
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-neutral-100 mb-1">Respect Other Players</h4>
                          <p className="text-neutral-300 text-sm">
                            No griefing, stealing, or destroying others' builds without permission. PvP must be consensual. Pranks are allowed but should be harmless and fun.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-neutral-100 mb-1">Build Responsibly</h4>
                          <p className="text-neutral-300 text-sm">
                            Keep spawn area clean and organized. Clean up temporary structures and resource gathering sites.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-neutral-100 mb-1">Server Resources</h4>
                          <p className="text-neutral-300 text-sm">
                            No lag machines or excessive redstone contraptions near spawn.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-neutral-100 mb-1">Have Fun</h4>
                          <p className="text-neutral-300 text-sm">
                            This is a casual, friendly server. Play fair, be respectful, and enjoy the game with others!
                          </p>
                        </div>
                      </div>
                    </div>
